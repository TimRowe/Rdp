function OnTest(control, alertFlag, desc1, desc2, desc3, desc4, desc5, desc6) {
    ///////////////////////////////////////////////////////////////////////////////
    ...
    if (IsInteger(returnValue.substring(0, 8)) == false) {
        alert(desc5);
        document.all(control).value = "";
        rd.dc_exit();
        return true;
    ...
    //alert("dc_exit ok!");
    document.all(control).value = returnValue.substring(0, 8);
}
