...
(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<a href="javascript:;" style="z-index:999" data-calendar-display-date class="calendar-display">',
            '{yyyy}-<span class="m">{mm}</span>',
            '</a>',
            '<p class="addMock" id="mmmm"></p>',
            ...
            '<div class="calendar-hd">',
            '<a href="javascript:;" style="z-index:999" data-calendar-display-month class="calendar-display">{yyyy}</a>',
            '<div class="calendar-arrow">',
    ...
    Calendar.prototype = {
        ...
        resize: function() {
            ...
            this.$element.width(w).height(h + hdH)
                ...
                .css('width', w + 'px');
          var qqm = $(window).width();
          if(qqm <1440){
            this.$element.find('.calendar-ct').width(w).height(h-18);
          }else{
              this.$element.find('.calendar-ct').width(w).height(h-20);
          }
        },
        init: function() {
